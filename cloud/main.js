...
var googleClientId = 'YOUR-GOOGLE-CLIENT-ID'; //The client ID obtained from the Google Developers Console, follow the steps above
var googleClientSecret = 'YOUR-GOOGLE-CLIENT-SECRET'; //The client secret obtained from the Google Developers Console, follow the steps above
